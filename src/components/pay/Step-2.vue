...
<template>
  <div class="step-2">
    ...
    <div class="receipt-header">
      ...
      <div class="fee-item">
        <div class="fee-label">Exchange Rate</div>
        <div class="fee-value">1 USDC = 1 USD</div>
      </div>
      <div class="fee-item">
        <div class="fee-label">Processing Fee</div>
        <div class="fee-value">0.00 USDC</div>
      </div>
      <div class="fee-item">
        <div class="fee-label">Fx Markup Rate</div>
        <div class="fee-value">0.00 USDC</div>
      </div>
      <div class="fee-item">
        <div class="fee-label">Additional Fee</div>
        <div class="fee-value">0.00 USDC</div>
      </div>
    </div>
    ...
    <div class="transaction-details">
      <div class="detail-row">
        ...
        <div class="detail-value">{{ formatHash(payment?.id) }}</div>
      </div>
      <div class="detail-row">
      ...
      <div class="detail-row">
        ...
        <div class="detail-value">{{ payment?.term }}</div>
      </div>
      <div class="detail-row">
        <div class="detail-label">Payer Name</div>
        <div class="detail-value">{{ payment?.firstName }} {{ payment?.middleName }} {{ payment?.familyName }}</div>
      </div>
      <div class="detail-row">
